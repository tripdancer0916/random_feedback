...
plt.savefig("BP-RFA_for_mnist(tanh).png")
plt.figure()
plt.plot(train_acc_list[20:], label="BP train acc", linestyle="dashed", color="blue")
...
plt.savefig("BP-RFA_for_mnist_20start(tanh).png")
