...
class MLP:
    def __init__(self, weight_init_std=0.02):
        ...
        self.b4 = weight_init_std * cp.zeros(10)
        # self.b5 = weight_init_std * cp.random.randn(10)

        self.B2 = weight_init_std * (cp.random.rand(hidden_unit2, hidden_unit1)*2-1)
        self.B3 = weight_init_std * (cp.random.rand(hidden_unit3, hidden_unit2)*2-1)
        # self.B4 = weight_init_std * cp.random.randn(hidden_unit4, hidden_unit3)
        self.B4 = weight_init_std * (cp.random.rand(10, hidden_unit3)*2-1)
