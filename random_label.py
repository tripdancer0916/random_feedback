...
plt.plot(train_acc_list, label="BP train acc", color="blue")
...
plt.plot(train_acc_list_FA, label="RFA train acc",color="red")
# plt.plot(test_acc_list_FA, label="RFA test acc", color="red")
