...
np.savetxt("./result/0820/FA_regcifarW1.txt", cuda.to_cpu(mlp.W_f1))
np.savetxt("./result/0820/FA_regcifarW2.txt", cuda.to_cpu(mlp.W_f2))
np.savetxt("./result/0820/FA_regcifarW3.txt", cuda.to_cpu(mlp.W_f3))
np.savetxt("./result/0820/FA_regcifarW4.txt", cuda.to_cpu(mlp.W_f4))
np.savetxt("./result/0820/FA_regcifarW5.txt", cuda.to_cpu(mlp.W_f5))
np.savetxt("./result/0820/FA_regcifarb1.txt", cuda.to_cpu(mlp.b1))
np.savetxt("./result/0820/FA_regcifarb2.txt", cuda.to_cpu(mlp.b2))
np.savetxt("./result/0820/FA_regcifarb3.txt", cuda.to_cpu(mlp.b3))
np.savetxt("./result/0820/FA_regcifarb4.txt", cuda.to_cpu(mlp.b4))
np.savetxt("./result/0820/FA_regcifarb5.txt", cuda.to_cpu(mlp.b5))
