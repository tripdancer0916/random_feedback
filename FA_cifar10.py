...
os.makedirs('./result/0803/', exist_ok=True)
...
np.savetxt("./result/0803/FA_cifarW1.txt", cuda.to_cpu(mlp.W_f1))
np.savetxt("./result/0803/FA_cifarW2.txt", cuda.to_cpu(mlp.W_f2))
np.savetxt("./result/0803/FA_cifarW3.txt", cuda.to_cpu(mlp.W_f3))
np.savetxt("./result/0803/FA_cifarW4.txt", cuda.to_cpu(mlp.W_f4))
