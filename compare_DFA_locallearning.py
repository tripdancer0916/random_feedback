...
for i in range(20000):
    ...
    if i % iter_per_epoch == 0:
        ...
        print(int(i / iter_per_epoch), train_loss, mlp.angle(cp.asarray(mlp.d), mlp.delta4), test_acc)
...
for i in range(20000):
    ...
    if i % iter_per_epoch == 0:
        ...
        print(int(i / iter_per_epoch), train_loss, mlp.angle(cp.ones(10), mlp.delta4), test_acc)
        # print("epoch:", int(i / iter_per_epoch), " train loss, test loss, train acc, test acc | " + str(train_loss)
        #       + ", " + str(test_loss) + ", " + str(train_acc) + ", " + str(test_acc))
