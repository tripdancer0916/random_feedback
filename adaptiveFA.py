...
os.makedirs('./result/0822/', exist_ok=True)
...
train_acc_list_FA = []
test_acc_list_FA = []
f = open('./result/0822/angle_log.txt', 'a')
...
np.savetxt("./result/0822/FA_cifarW1.txt", cuda.to_cpu(mlp.W_f1))
np.savetxt("./result/0822/FA_cifarW2.txt", cuda.to_cpu(mlp.W_f2))
np.savetxt("./result/0822/FA_cifarW3.txt", cuda.to_cpu(mlp.W_f3))
np.savetxt("./result/0822/FA_cifarW4.txt", cuda.to_cpu(mlp.W_f4))
np.savetxt("./result/0822/FA_cifarW5.txt", cuda.to_cpu(mlp.W_f5))
np.savetxt("./result/0822/FA_cifarb1.txt", cuda.to_cpu(mlp.b1))
np.savetxt("./result/0822/FA_cifarb2.txt", cuda.to_cpu(mlp.b2))
np.savetxt("./result/0822/FA_cifarb3.txt", cuda.to_cpu(mlp.b3))
np.savetxt("./result/0822/FA_cifarb4.txt", cuda.to_cpu(mlp.b4))
np.savetxt("./result/0822/FA_cifarb5.txt", cuda.to_cpu(mlp.b5))
