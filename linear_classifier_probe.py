...
if __name__ == '__main__':
    ...
    dfa_W1 = cp.load("./fashion_model/dfa_25000_W_f4.npy")
    dfa_W2 = cp.load("./fashion_model/BP_cifarW2.txt")
    dfa_W3 = cp.load("./fashion_model/BP_cifarW3.txt")
    dfa_W4 = cp.load("./fashion_model/BP_cifarW4.txt")
    dfa_W5 = cp.load("./fashion_model/BP_cifarW5.txt")
